<?php $shippingClass = $product->get_shipping_class() ?>
<div id='shipping-calc'>
	
	<div class="title__modal<?php if($shippingClass) echo ' '.$shippingClass.'-icon' ?>">
	...
	<div>
	<?php if($shippingClass === 'frete-gratis'): ?>
		<div class="frete-gratis-text">
		<strong>Envio Grátis para todo o país</strong>
	<?php else: ?>
		<div>
	...
	<div id="shipping-calculator-modal" uk-modal>
		...
		<h2 class="uk-modal-title">Calcule o frete para saber os valores de entrega</h2>
			...
			<button id='wscp-button' class='button wscp-button' value='' ><?= __('Calcular','wsc-plugin'); ?></button>
